	        ...
	        Thread.sleep(5000);
			  ...
			  Actions actions = new Actions(driver);
				...
				WebElement element = driver.findElement(By.xpath("//div[@help-id='CurrentAge']//div[@class='control-well']"));
					...
					actions.moveToElement(element).click().sendKeys("55").perform();
					...
					driver.findElement(By.xpath("//span[@class='ng-scope' and text()='Not employed']")).click();
					
					//Kiwisaver balance					
					element = driver.findElement(By.xpath("//div[@help-id ='KiwiSaverBalance']//div[@class='control-well']"));
					actions.moveToElement(element).click().sendKeys("1400000").perform();
					...
					actions.moveToElement(element).click().perform();
					driver.findElement(By.xpath("//input[@class='ng-pristine ng-valid']")).sendKeys("10");

					driver.findElement(By.xpath("//div[@class='dropdown']//li[@value='year']")).click();
					...
					actions.moveToElement(element).click().sendKeys("200000").perform();
